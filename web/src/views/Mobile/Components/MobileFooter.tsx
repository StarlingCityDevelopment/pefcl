  ...
  return (
    ...
    >
      <div className='flex flex-row items-center justify-between h-full max-w-lg mx-auto'>
        <ListItem icon={<LayoutDashboard className='w-5 h-5' />} label={t('Overview')} to='../mobile/dashboard' />
        <ListItem icon={<Wallet className='w-5 h-5' />} label={t('Banks')} to='../mobile/accounts' />
        <ListItem icon={<ArrowLeftRight className='w-5 h-5' />} label={t('Transfer')} to='../mobile/transfer' />
        <ListItem
