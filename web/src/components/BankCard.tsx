  ...
  return (
    <div
      className={cn(
        ...
        selected ? 'bg-white/[0.08] border-white ring-1 ring-white/20' : 'border-white/5',
      )}
    >
      {/* Glossy edge effect */}
      ...
      <div className='relative z-10'>
        ...
        <Typography className='text-lg font-mono font-black text-white tracking-[0.15em] opacity-80 group-hover:opacity-100 transition-all'>
          {card.number}
        </Typography>
      </div>
