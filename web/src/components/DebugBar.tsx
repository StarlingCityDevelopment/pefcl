...
const Devbar = () => {
 ...
 <Typography variant="pre" className="text-slate-500 font-black">Debug Panel</Typography>
 ...
 <Typography className="text-[10px] uppercase font-bold text-slate-600 tracking-widest pl-1">Interface Controls</Typography>
 ...
 >
 <span>Bank UI</span>
 <span className={cn("w-2 h-2 rounded-full", isBankOpen ? "bg-white -[0_0_8px_white]" : "bg-white/10")} />
 </Button>
 <Button 
 ...
 >
 <span>ATM UI</span>
 <span className={cn("w-2 h-2 rounded-full", isAtmOpen ? "bg-white -[0_0_8px_white]" : "bg-white/10")} />
 </Button>
 </div>
 </div>
 </div>
