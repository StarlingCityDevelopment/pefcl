...
import { AlertCircle, ArrowRight, Calendar, CheckCircle2, MessageSquare, User, Wallet } from 'lucide-react';
  ...
  if (isPaid) {
    return (
      <div className='flex flex-col items-center justify-center py-12 px-6 min-h-[300px]'>
        ...
        <Typography className='text-slate-400 text-sm'>{t('Invoice has been successfully paid.')}</Typography>
      </div>
    );
  }
        ...
        <div className='p-5 rounded-2xl bg-white/[0.02] border border-white/5 flex flex-col gap-5'>
          <div className='flex items-start gap-3'>
            ...
            <div className='flex flex-col flex-1 min-w-0'>
              <Typography
                variant='label'
                className='mb-0.5 text-[10px] opacity-40 uppercase tracking-widest font-medium'
              >
                {t('From')}
              </Typography>
